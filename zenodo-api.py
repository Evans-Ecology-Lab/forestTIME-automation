...
for folder in folders:
  # instead get collection of files and add them to the zip folder 
  pqs = folder.iterdir()
  print("state",folder.name,"parquets,",pqs)
  sp.run(f"zip -r fia/parquet/{folder.name}.zip {' '.join(pqs)}",shell=True)
